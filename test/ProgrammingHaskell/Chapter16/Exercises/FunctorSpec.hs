...
testIdentity = context "Identity" $ do
    ...
    it "Obeys Functor composition law" $ do
        property (functorCompose :: Identity Int -> Fun Int String -> Fun String Int -> Bool)
...
testPair = context "Pair" $ do
    ...
    it "Obeys Functor composition law" $ do
        property (functorCompose :: Pair Int -> Fun Int String -> Fun String Int -> Bool)
...
testTwo = context "Two" $ do
    ...
    it "Obeys Functor composition law" $ do
        property (functorCompose :: Two String Int -> Fun Int String -> Fun String Int -> Bool)
...
testThree = context "Three" $ do
    ...
    it "Obeys Functor composition law" $ do
        property (functorCompose :: Three String String Int -> Fun Int String -> Fun String Int -> Bool)
...
testThree' = context "Three'" $ do
    ...
    it "Obeys Functor composition law" $ do
        property (functorCompose :: Three' String Int -> Fun Int String -> Fun String Int -> Bool)
...
testFour = context "Four" $ do
    ...
    it "Obeys Functor composition law" $ do
        property (functorCompose :: Four String String String Int -> Fun Int String -> Fun String Int -> Bool)
...
testFour' = context "Four'" $ do
    ...
    it "Obeys Functor composition law" $ do
        property (functorCompose :: Four' String Int -> Fun Int String -> Fun String Int -> Bool)
