...
exercise_2_12_1   = let x = 3; y = 1000 in x * 3 + y
exercise_2_12_1'  = x * 3 + y where x = 3; y = 1000
exercise_2_12_1'' = (\x -> (\y -> x * 3 + y)) 3 1000

exercise_2_12_2   = let y = 10; x = 10 * 5 + y in x * 5
exercise_2_12_2'  = x * 5 where y = 10; x = 10 * 5 + y
exercise_2_12_2'' = (\y -> (\x -> x * 5) (10 * 5 + y)) 10

exercise_2_12_3   = let x = 7; y = negate x; z = y * 10 in z / x + y
exercise_2_12_3'  = z / x + y where x = 7; y = negate x; z = y * 10
